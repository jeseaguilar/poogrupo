		...
		<div class="grid-1">
			<div class="form-body">
				<form class="form-horizontal" method="post">
					<div class="form-group"> <label for="inputEmail3" class="col-sm-2 control-label">nombre</label>
					...
					<div class="form-group"> <label for="inputEmail3" class="col-sm-2 control-label">direccion</label>
					...
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">segundo apellido</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="up_father" value="<?php echo $edit_teacher_display['t_father']; ?>"> </div>

					</div>
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">seg apellido</label>
					...
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">Contactos</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="up_contact" value="<?php echo $edit_teacher_display['t_contact']; ?>"> </div>

					</div>
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">Staff /label>
					...
					<div class="form-group">
						...
						<select id="selector1" class="form-control1" name="up_gender">
						   <option value="<?php echo $edit_teacher_display['t_gender']; ?>">Seleccione Genero</option>
					...
					<div class="col-sm-offset-2"> <button type="submit" class="btn btn-default" name="up_teacher">cambiar perfil del maestro</button> </div>
				</form>
			</div>
