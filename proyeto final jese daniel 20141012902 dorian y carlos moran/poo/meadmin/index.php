...
if(isset($_POST['admin_signin']))
{
	...
	{
		echo "<script>alert('info no correcta');</script>";
	}
...
<html>
<head>
<title>aprendamos | Login :: w3layouts</title>
...
<body>
									   ...
									   <div class="error_page">
												<!--/login-top-->
													...
													<div class="error-top">
														...
														<h2 class="inner-tittle page">Logeo</h2>
													
													    <div class="login">
															<h3 class="inner-tittle t-inner">administrador maestro</h3>
																...
																<form method="post">
					<input type="text" class="text" name="admin_username" placeholder="Usuario" value="<?php if(isset($_POST['admin_signin'])){ echo $_POST['admin_username']; } ?>">
				...
				<div class="submit"><input type="submit" value="Login" name="admin_signin"></div>
									<div class="clearfix"></div>
										...
										<div class="footer">
												<div class="error-btn">
															<a class="read fourth" href="index.html">Retorna al principio</a>
															</div>
										   <p>&poo aprendamos <a href="https://w3layouts.com/" target="_blank">W3layouts.</a></p>
										</div>
									<!--footer section end-->
									<!--/404-->
<!--js -->
