...
<div class="forms-main">
	...
	$web_info_check = $ravi->general_setting_check();
	  ...
	  if($check_we>0)
	  {
		 echo "<script>alert('info agregada ');</script>" ;
...
?>
			...
			<form method="post">
					...
					<input type="text" placeholder="nombre del sitio" name="web_name">
				</div>
				<div class="vali-form">
					...
					<div class="col-md-6 form-group1 form-last">
						...
						<input type="text" placeholder="direccon" name="web_address">
					</div>
					
						<div class="col-md-6 form-group1">
						<label class="control-label">telefono principal</label>
						<input type="text" placeholder="" name="web_phone1">
					</div>
					...
					<div class="col-md-6 form-group1 form-last">
						...
						<input type="text" placeholder="1 Email" name="web_email1">
					</div>
					<div class="col-md-6 form-group1">
						<label class="control-label">2 Email</label>
						<input type="text" placeholder="2 Email" name="web_email2">
					</div>
					<div class="col-md-6 form-group1 form-last">
