<?php 
 ...
 if(isset($_POST['std_add_now']))
 {
	 ...
	 {
		 echo "<script>alert('porfavor llene info del estudiante');</script>";
	 }
	 else
	 {
...
<div class="forms-main">
	...
	<div class="graph-form">
		<div class="validation-form">
			<!---->
			<h2 align="center"><?php echo ($_GET['ravi']); ?></h2>
			<form method="post">
					<div class="col-md-12 form-group1 group-mail">
					<label class="control-label">Fnombre</label>
					<input type="text" placeholder="nombre completo" required="" name="std_fullname">
				</div>
				<div class="vali-form">
					...
					<div class="col-md-6 form-group1 form-last">
						...
						<input type="text" placeholder="Usuario" required="" name="std_username">
					</div>
					...
					<label class="control-label">genero</label>
						<input type="text" placeholder="eg: genero" required="" name="std_gender">
					</div>
					<div class="clearfix"> </div>
					<div class="col-md-6 form-group1">
					...
					<div class="col-md-6 form-group1">
						...
						<input type="text" placeholder="direccion" required="" name="std_address">
					</div>
					<div class="col-md-6 form-group1 form-last">
						<label class="control-label">ciudad</label>
						<input type="text" placeholder="ciudad" required="" name="std_district">
					</div>
				
					<div class="col-md-6 form-group1 form-last">
						<label class="control-label">er apellido</label>
						<input type="text" placeholder="er apellido" required="" name="std_father">
					</div>
					<div class="col-md-6 form-group1">
						<label class="control-label">segundo</label>
						<input type="text" placeholder="segundo apellido" required="" name="std_mother">
					</div>
					<div class="col-md-12 form-group1 form-last">
						<label class="control-label">contacto de los padre</label>
						<input type="text" placeholder="Contacto numero" required="" name="std_parent_contact">
					</div>
				</div>
					<div class="clearfix"> </div>
				<div class="col-md-12 form-group button-2">
					<input type="submit" class="btn btn-primary" value="agregar estudiante" name="std_add_now">
					<button type="reset" class="btn btn-default">Resetiar</button>
				</div>
				<div class="clearfix"> </div>
			</form>
