<?php 
 if(isset($_POST['add_table']))
 {
 	...
 	{
 		echo "<script>alert('Success Added $Nepdev_table_Name'); window.location='http://localhost/projects/project2/meadmin/home.php?ravi=agregar-tabla';</script>";
 	}
 	else
 	{
 		echo "<script>alert('Cant Added $Nepdev_table_Name'); window.location='http://localhost/projects/project2/meadmin/home.php?ravi=agregar-tabla';</script>";
 	}
}
...
<form method="post">
	<div class="col-md-12 form-group1 group-mail">
					<label class="control-label">agregar a examen</label>
					<input type="text" placeholder="primer_termino" required="" name="Nepdev_exam_term">
				</div>

				<div class="col-md-12 form-group button-2">
					<input type="submit" class="btn btn-primary" value="modificar valor de examen" name="add_exam_term">
					
				</div>
</form>
			<form method="post">
					<div class="col-md-6 form-group1 group-mail">
					<label class="control-label">nombre en tablas</label>
					<input type="text" placeholder="Tabla Nombre eg: Curso 1" required="" name="Nepdev_table_Name">
				</div>
				<div class="col-md-6 form-group1 form-last">
						<label class="control-label">cursos</label>
						<input type="text" value="nota del esudiante" name="grade" readonly="">
					</div>
				<div class="clearfix"> </div>
				<div class="col-md-6 form-group1 form-last">
						<label class="control-label">nombre de estudiantes</label>
					...
					<div class="clearfix"> </div>
						...
						<div class="col-md-6 form-group1">
						<label class="control-label">Examen de curso</label>
