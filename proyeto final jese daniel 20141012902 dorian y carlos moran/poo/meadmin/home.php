...
<body>
	<div class="page-container">
		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu">
					<li><a href="home.php"><i class="fa fa-tachometer"></i> <span>inicio</span></a></li>
					<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span>estudiantes</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=estudiante-informacion"> informacion del estudiante</a></li>
							<li id="menu-academico-boletim"><a href="home.php?ravi=Agregar-estudiante">Agregar nuevo estudiante</a></li>
				...
				<li id="menu-academico"><a href="#"><i class="fa fa-table"></i> <span>base de datos</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=estudiante-informacion">informacion de la base de datos</a></li>
					...
					<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=maestros-informacion">informacion de los maestros</a></li>
							<li id="menu-academico-avaliacoes"><a href="home.php?ravi=maestro-editar">Editar info de maestro</a></li>
							<li id="menu-academico-boletim"><a href="home.php?ravi=agregar-maestro">Agregar maestro</a></li>
